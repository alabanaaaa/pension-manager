  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
        ...
        <Link to="/voting/new" className="btn-hover flex items-center gap-2 px-4 py-2.5 bg-neutral-900 text-white rounded-2xl text-sm font-medium hover:bg-neutral-800 transition-all">
      ...
      {loading ? (
        ...
        <div className="grid gap-5">
          {elections.map(e => {
            ...
            return (
              <div key={e.id} className="bg-white rounded-2xl border border-[#e8e9eb] p-5 hover:shadow-sm transition-all">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-5">
                  ...
                  <div className="flex gap-2 flex-shrink-0">
                    <Link to={`/voting/${e.id}/results`} className="btn-hover flex items-center gap-1.5 px-4 py-2.5 border border-neutral-200 rounded-2xl text-sm hover:bg-neutral-50 transition-all">
                      <BarChart3 size={14} /> Results
                    </Link>
                    <Link to={`/voting/${e.id}`} className="btn-hover flex items-center gap-1.5 px-4 py-2.5 bg-neutral-900 text-white rounded-2xl text-sm hover:bg-neutral-800 transition-all">
